  ...
  Vue.createApp({
    ...
    data() {
      return {  
        ...
        inputFocused: false,
        showImageText: true,
        showAttachmentButton: false, // New boolean property
      };
    },
...
const template = `<div class="div-chat-container">
            ...
            <div class="input-area" ref="inputArea">
                ...
                <div class="input-row">
                    <div class="message-input" contenteditable="true" :style="{ opacity: showImageText ? 1 : 0 }"
                        @input="handleInput" @input="autoResize" @keydown.enter.exact.ctrl="sendMessage"
